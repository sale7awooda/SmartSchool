import { Notice, User, Driver, BusRoute, Student, TimetablePeriod } from '@/types';

export const MOCK_NOTICES: Notice[] = [
  { id: 'NOT-001', title: 'End of Term Examinations Schedule', content: 'Please be advised that the end of term examinations will commence on November 15th. The detailed timetable has been emailed to all parents and students. Ensure students arrive 15 minutes early on exam days.', date: '2023-10-24T09:00:00Z', createdAt: '2023-10-24T09:00:00Z', author: '1', authorName: 'Principal Skinner', authorRole: 'School Admin', isImportant: true, targetAudience: 'all' },
  { id: 'NOT-002', title: 'Staff Meeting - Friday', content: 'There will be a mandatory staff meeting this Friday at 3:30 PM in the main hall to discuss the upcoming science fair logistics.', date: '2023-10-23T14:30:00Z', createdAt: '2023-10-23T14:30:00Z', author: '1', authorName: 'Principal Skinner', authorRole: 'School Admin', isImportant: false, targetAudience: 'staff' },
  { id: 'NOT-003', title: 'Fee Payment Reminder', content: 'A gentle reminder that Term 1 tuition fees are due by November 1st. Please check your dashboard for pending invoices. Late payments may incur a penalty.', date: '2023-10-20T10:15:00Z', createdAt: '2023-10-20T10:15:00Z', author: '3', authorName: 'Angela Martin', authorRole: 'Accountant', isImportant: true, targetAudience: 'parents' },
  { id: 'NOT-004', title: 'School Closed for Public Holiday', content: 'The school will remain closed on Monday, October 30th in observance of the national holiday. Classes will resume on Tuesday.', date: '2023-10-18T08:00:00Z', createdAt: '2023-10-18T08:00:00Z', author: '2', authorName: 'System Owner', authorRole: 'Super Admin', isImportant: false, targetAudience: 'all' }
];
