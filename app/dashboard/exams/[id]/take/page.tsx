    ...
    <div className="max-w-5xl mx-auto pb-20">
      ...
      {showConfirmSubmit && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          ...
          >
            <div className="flex items-center justify-center w-12 h-12 bg-indigo-500/10 text-indigo-500 rounded-full mx-auto">
              <CheckCircle2 size={24} />
            </div>
            <div className="text-center space-y-1">
              <h3 className="text-lg font-bold">{t('submit_exam_confirm')}</h3>
              <p className="text-xs text-muted-foreground font-semibold">
                Please double-check your answers before submitting. You cannot edit comments or choices after dispatch.
              </p>
            </div>
            <div className="flex gap-3 pt-2">
              ...
              <button
                ...
                className="flex-1 py-2.5 text-xs bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl"
              >
                Submit Now
              </button>
            </div>
