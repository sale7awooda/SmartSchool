    ...
    return (
      <div className="flex items-center justify-center h-[60vh]">
        <div className="text-center">
          ...
          <p className="text-slate-500 mt-2">You do not have permission to view advanced analytics.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 h-full flex flex-col">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 shrink-0">
        <div>
          <h1 className="text-3xl font-bold text-slate-900 tracking-tight">Advanced Analytics & Insights</h1>
          <p className="text-slate-500 mt-2 font-medium">Data-driven decision making and predictive modeling.</p>
        </div>
      ...
      <div className="flex overflow-x-auto scrollbar-hide bg-white p-1.5 rounded-2xl border border-slate-200 shadow-sm shrink-0">
        <button 
          ...
          className={`flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-bold transition-all whitespace-nowrap ${activeTab === 'overview' ? 'bg-indigo-50 text-indigo-700 shadow-sm' : 'text-slate-500 hover:text-slate-700 hover:bg-slate-50'}`}
        >
          <Activity size={18} />
          Overview
        </button>
        <button 
          ...
          className={`flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-bold transition-all whitespace-nowrap ${activeTab === 'academic' ? 'bg-indigo-50 text-indigo-700 shadow-sm' : 'text-slate-500 hover:text-slate-700 hover:bg-slate-50'}`}
        >
        ...
        <button 
          ...
          className={`flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-bold transition-all whitespace-nowrap ${activeTab === 'attendance' ? 'bg-indigo-50 text-indigo-700 shadow-sm' : 'text-slate-500 hover:text-slate-700 hover:bg-slate-50'}`}
        >
        ...
        <button 
          ...
          className={`flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-bold transition-all whitespace-nowrap ${activeTab === 'financial' ? 'bg-indigo-50 text-indigo-700 shadow-sm' : 'text-slate-500 hover:text-slate-700 hover:bg-slate-50'}`}
        >
          <DollarSign size={18} />
          Financial Health
        </button>
        <button 
          ...
          className={`flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-bold transition-all whitespace-nowrap ${activeTab === 'predictive' ? 'bg-indigo-50 text-indigo-700 shadow-sm' : 'text-slate-500 hover:text-slate-700 hover:bg-slate-50'}`}
        >
    ...
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
          ...
          <h3 className="text-slate-500 text-sm font-bold uppercase tracking-wider mb-1">Avg School Grade</h3>
          <p className="text-3xl font-black text-slate-900">86.4%</p>
        </div>
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
          ...
          <h3 className="text-slate-500 text-sm font-bold uppercase tracking-wider mb-1">Avg Attendance</h3>
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
          ...
          <h3 className="text-slate-500 text-sm font-bold uppercase tracking-wider mb-1">YTD Revenue</h3>
          <p className="text-3xl font-black text-slate-900">$768K</p>
        </div>
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
          ...
          <h3 className="text-slate-500 text-sm font-bold uppercase tracking-wider mb-1">At-Risk Students</h3>
      ...
      {/* Main Chart */}
      <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
        <h3 className="text-lg font-bold text-slate-900 mb-6">School Performance Index</h3>
...
function AcademicTab() {
  return (
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="space-y-6">
      <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
        <h3 className="text-lg font-bold text-slate-900 mb-6">Subject Performance Trends</h3>
...
function AttendanceTab() {
  return (
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="space-y-6">
      <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
        <h3 className="text-lg font-bold text-slate-900 mb-6">Weekly Attendance Breakdown</h3>
        <div className="h-[400px]">
          <ResponsiveContainer width="100%" height="100%">
...
function PredictiveTab() {
  return (
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="space-y-6">
      <div className="bg-indigo-600 rounded-[2rem] p-6 sm:p-8 text-white relative overflow-hidden shadow-sm">
      ...
      <div className="bg-white rounded-[2rem] border border-slate-100 shadow-sm overflow-hidden">
        <div className="p-6 border-b border-slate-100">
          ...
          <p className="text-sm font-medium text-slate-500 mt-1">Students flagged by the predictive model requiring attention.</p>
        </div>
              ...
              <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    <h4 className="font-bold text-slate-900 text-lg">{alert.student}</h4>
                    <span className="text-sm font-medium text-slate-500">{alert.grade}</span>
                  ...
                  <p className="text-sm text-slate-600 font-medium mb-3">
                    <span className="text-slate-900 font-bold">Trigger:</span> {alert.reason}
                  </p>
                  <div className="inline-flex items-center gap-2 px-3 py-2 bg-indigo-50 text-indigo-700 rounded-xl text-sm font-bold">
                    <Activity size={16} />
                    Recommended Action: {alert.action}
                  </div>
                </div>
                <div className="shrink-0 flex gap-2">
                  <button className="px-4 py-2 bg-white border border-slate-200 text-slate-700 rounded-xl font-bold text-sm hover:bg-slate-50 transition-colors shadow-sm">
                    Dismiss
                  </button>
                  <button className="px-4 py-2 bg-indigo-600 text-white rounded-xl font-bold text-sm hover:bg-indigo-700 transition-colors shadow-sm">
                    Take Action
                  </button>
                </div>
              </div>
